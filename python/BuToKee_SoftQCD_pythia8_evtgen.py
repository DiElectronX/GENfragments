...
#
Decay MyB+
1.000  K+      e+     e-    PHOTOS BTOSLLBALL 6;
Enddecay
CDecay MyB-
#
End
...
decayfilterpositiveleg = cms.EDFilter(
    ...
    ParticleID      = cms.untracked.int32(521),  ## Bu
    DaughterIDs     = cms.untracked.vint32(321, 11, -11), ## K+ and e+ or e-
    MinPt           = cms.untracked.vdouble(0.5, 3.0, 3.0),
    MinEta          = cms.untracked.vdouble(-2.5, -1.5, -1.5),
    MaxEta          = cms.untracked.vdouble( 2.5,  1.5,  1.5)
    )

ProductionFilterSequence = cms.Sequence(generator*bufilter*decayfilterpositiveleg)
