...
"""
#
# This is the decay file for the decay B+ -> J/Psi Kstar + -> e+ e- K+
#
Alias      MyB+        B+
Alias      MyB-        B-
ChargeConj MyB+        MyB-
...
decayfilter = cms.EDFilter(
    ...
    DaughterIDs     = cms.untracked.vint32(443, 323), ## J/psi and K*+
...
ProductionFilterSequence = cms.Sequence(generator*decayfilter*jpsifilter*kstarfilter)
