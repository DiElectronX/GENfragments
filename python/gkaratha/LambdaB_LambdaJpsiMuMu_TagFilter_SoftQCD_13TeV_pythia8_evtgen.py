...
# Found 20 output events for 8000 input events.
# Filter efficiency = 0.0025
# Timing = 0.389641 sec/event
# Event size = 646.2 kB/event
#
...
mufilter = cms.EDFilter("MCMultiParticleFilter",
            ...
            MotherID = cms.untracked.vint32(443),
            AcceptMore = cms.bool(True)
            )

ProductionFilterSequence = cms.Sequence(generator*lbfilter*decayfilter*jpsifilter*mufilter)
